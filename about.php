...
<body>
    ...
    <div id="content">
            <div style="padding-top:70px">
                  <h2 style="float:right;padding-right:150px;"><span style="background-color:#006ba4;padding:10px">About me</span></h2>
                  <p>&nbsp;</p>
    ...
    <div class="section2">
       <div id="content">
            <h3>My Life</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In tristique eros turpis, ac elementum massa cursus id. Suspendisse ut ante sit amet nibh dignissim ullamcorper vel eget lorem. Donec felis nisl, bibendum in erat vitae, tempus dapibus dolor. Nullam non ultricies odio. Aliquam congue velit eget arcu porttitor tincidunt. Phasellus luctus lectus sit amet magna lobortis, vitae porta massa placerat. Aenean a accumsan turpis. Integer facilisis sem vitae arcu ullamcorper lacinia. Fusce sit amet velit id purus malesuada consequat vitae in urna.</p>
